...
import static com.animcubeandroid.CubeConstants.AnimationMode;
import static com.animcubeandroid.CubeConstants.ComputationLogic.adjacentFaces;
import static com.animcubeandroid.CubeConstants.ComputationLogic.areaDirs;
import static com.animcubeandroid.CubeConstants.ComputationLogic.blockMode;
import static com.animcubeandroid.CubeConstants.ComputationLogic.border;
import static com.animcubeandroid.CubeConstants.ComputationLogic.botBlockFaceDim;
import static com.animcubeandroid.CubeConstants.ComputationLogic.cornerCoords;
import static com.animcubeandroid.CubeConstants.ComputationLogic.cubeBlocks;
import static com.animcubeandroid.CubeConstants.ComputationLogic.cycleCenters;
import static com.animcubeandroid.CubeConstants.ComputationLogic.cycleFactors;
import static com.animcubeandroid.CubeConstants.ComputationLogic.cycleLayerSides;
import static com.animcubeandroid.CubeConstants.ComputationLogic.cycleOffsets;
import static com.animcubeandroid.CubeConstants.ComputationLogic.cycleOrder;
import static com.animcubeandroid.CubeConstants.ComputationLogic.dragBlocks;
import static com.animcubeandroid.CubeConstants.ComputationLogic.drawOrder;
import static com.animcubeandroid.CubeConstants.ComputationLogic.eyeOrder;
import static com.animcubeandroid.CubeConstants.ComputationLogic.faceCorners;
import static com.animcubeandroid.CubeConstants.ComputationLogic.faceNormals;
import static com.animcubeandroid.CubeConstants.ComputationLogic.faceTwistDirs;
import static com.animcubeandroid.CubeConstants.ComputationLogic.factors;
import static com.animcubeandroid.CubeConstants.ComputationLogic.midBlockFaceDim;
import static com.animcubeandroid.CubeConstants.ComputationLogic.midBlockTable;
import static com.animcubeandroid.CubeConstants.ComputationLogic.modeChar;
import static com.animcubeandroid.CubeConstants.ComputationLogic.moveCodes;
import static com.animcubeandroid.CubeConstants.ComputationLogic.moveModes;
import static com.animcubeandroid.CubeConstants.ComputationLogic.oppositeCorners;
import static com.animcubeandroid.CubeConstants.ComputationLogic.rotCos;
import static com.animcubeandroid.CubeConstants.ComputationLogic.rotSign;
import static com.animcubeandroid.CubeConstants.ComputationLogic.rotSin;
import static com.animcubeandroid.CubeConstants.ComputationLogic.rotVec;
import static com.animcubeandroid.CubeConstants.ComputationLogic.topBlockFaceDim;
import static com.animcubeandroid.CubeConstants.ComputationLogic.topBlockTable;
import static com.animcubeandroid.CubeConstants.ComputationLogic.twistDirs;
import static com.animcubeandroid.CubeConstants.CubeAlign;
import static com.animcubeandroid.CubeConstants.CubeColors;
import static com.animcubeandroid.CubeConstants.CubeState;
import static com.animcubeandroid.CubeConstants.DEFAULT_INITIAL_CUBE_ROTATION;
import static com.animcubeandroid.CubeUtils.darkerColor;
import static com.animcubeandroid.CubeUtils.vAdd;
import static com.animcubeandroid.CubeUtils.vCopy;
import static com.animcubeandroid.CubeUtils.vMul;
import static com.animcubeandroid.CubeUtils.vNorm;
import static com.animcubeandroid.CubeUtils.vProd;
import static com.animcubeandroid.CubeUtils.vScale;
import static com.animcubeandroid.CubeUtils.vSub;
...
public class AnimCube extends SurfaceView implements View.OnTouchListener {
    ...
    public void initState(String cubeColorsString) {
        if (cubeColorsString == null || cubeColorsString.length() != 54) {
            setCubeInDefaultState();
        } else {
            setStringCubeModelInternal(cubeColorsString);
